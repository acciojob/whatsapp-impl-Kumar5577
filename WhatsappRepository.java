...
public class WhatsappRepository {
    ...
    public  String changeAdmin(User approver,User user,Group group) throws Exception{
        if(!groupUserMap.containsKey(group))throw  new Exception("Group doesn't exist");
        if(!adminMap.containsKey(approver)) throw new Exception("Approver doesn't have rights");
